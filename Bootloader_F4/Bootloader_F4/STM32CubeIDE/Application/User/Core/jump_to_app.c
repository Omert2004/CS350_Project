...
static void BL_Erase_App(void) // can be modified from user input
{
    ...
    HAL_FLASH_Lock();
    tfp_printf("ERASE OF SECTORS DONE");
}
...
void Bootloader_Run(void)
{
	...
	HAL_UART_Receive(&huart1, &startaddr, 4, HAL_MAX_DELAY);
	tfp_printf("Received addr = %X\r\n", startaddr);
